    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-12'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          <p>Welcome to Prescripto, your trusted partner 
            in managing your healthcare needs conveniently and efficiently. 
            At Prescripto, we understand the challenges individuals face when it comes 
            to scheduling doctor
          ...
          <p>Prescripto is committed to excellence in healthcare technology.
             ...
             advancements to improve user experience and deliver superior service. Whether youv are 
